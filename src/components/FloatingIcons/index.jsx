...
const FloatingIcons = () => {
  return (
    <div className="z-[10] flex justify-between w-full items-center my-14">
      <a href="mailto:sarthakvaish184@gmail.com" className="social">
        <motion.span
      ...
      <a href="https://github.com/marssarthak" target="_blank" className="social">
        <motion.span
          animate={{ opacity: 1, scale: 1 }}
          initial={{ opacity: 0, scale: 0 }}
          transition={{
      ...
      <a
        href="https://linkedin.com/in/vaishsarthak/"
        target="_blank"
        className="social"
      >
        <motion.span
